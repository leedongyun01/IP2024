...
OpenCV와 Python을 활용하여 영상 처리의 기초부터 고수준 알고리즘(추적, 배경 분리, 포즈 추정)까지 단계별로 구현한 저장소입니다.
...
## 🎬 실행 결과 (주요 사례)
* **Homework 1**: [시연 영상](https://youtu.be/gmGGQnETNt0)
* **Homework 2**: [시연 영상](https://youtu.be/mRtuVvzEcHU)
* **Homework 4**: [시연 영상](https://www.youtube.com/watch?v=reNW9nLBRlI)
